package com.th.serial.client;

import com.th.serial.cache.DataCacheManager;
import com.th.serial.protocol.BinaryFrame;
import com.th.serial.protocol.BinaryFrameDecoder;
                    ...
                    public void initChannel(SocketChannel ch) {
                        ...
                        p.addLast(new ChannelInboundHandlerAdapter() {
                            ...
                            public void channelActive(ChannelHandlerContext ctx) throws Exception {
                                ...
                                String rtuId = com.th.serial.utils.MicroConfig.readString("rtu.id");
                                String secret = com.th.serial.utils.MicroConfig.readString("rtu.secret");
